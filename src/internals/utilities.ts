...
export async function checkAndInstallPackages(configs: IModule): Promise<IInstallPackagesCommandResult> {
...
export async function installPackages(packageList: string[], dev: boolean): Promise<void> {
